 ...
 */
public class SPiece extends BasePiece {

	//piece properties
	private Color color 				= Color.ORANGE;
	protected short [][] assetsLeft		= {{0, 0}, {1,  -1}, {2, 0}, {3, -1}};
	protected short [][] assetsRight	= {{0, 3}, {1, 3}, {2, 3}, {3, 3}};
	...
	protected short [][][] piece 		= {{{0, 1}, {0, 2}, {1, 0}, {1, 1}},
									   	   {{0, 1}, {1, 1}, {1, 2}, {2, 2}},
									   	   {{0, 1}, {0, 2}, {1, 0}, {1, 1}},
									   	   {{0, 1}, {1, 1}, {1, 2}, {2, 2}}};
