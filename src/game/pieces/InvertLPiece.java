...
/**
 * Class representing the inverted L piece
 */
public class InvertLPiece extends BasePiece {

	//piece properties
	private Color color 				= Color.RED;
	protected short [][] assetsLeft		= {{0, 0}, {1, 0}, {2, -1}, {3, 0}};
	protected short [][] assetsRight	= {{0, 2}, {1, 3}, {2,  3}, {3, 3}};
	protected short [][] assetsHeight	= {{0, 3}, {1, 2}, {2,  3}, {3, 2}};
	protected short [][] assetsWidth	= {{0, 2}, {1, 3}, {2,  2}, {3, 3}};
	protected short [][] pieceHeight	= {{0, 3}, {1, 2}, {2,  3}, {3, 2}};
	protected short [][][] piece 		= {{{0, 1}, {1, 1}, {2, 0}, {2, 1}},
			   						   	   {{0, 0}, {1, 0}, {1, 1}, {1, 2}},
			   						   	   {{0, 1}, {0, 2}, {1, 1}, {2, 1}},
			   						   	   {{0, 0}, {0, 1}, {0, 2}, {1, 2}}};
