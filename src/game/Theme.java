...
public class Theme {
    ...
    private String [] nextLabels        = {"next_bl", "next_w", "next_w", "next_bb", "next_b", "next_bb", "next_bb", "next_w"};
    private String [] holdLabes         = {"hold_bl", "hold_w", "hold_w", "hold_bb", "hold_b", "hold_bb", "hold_bb", "hold_w"};
